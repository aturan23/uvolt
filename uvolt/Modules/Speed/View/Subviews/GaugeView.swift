...
class GaugeView: UIView {
    ...
    var numOfDivisions: Int = 6
    
    /// The number of subdivisions.
    var numOfSubDivisions: Int = 10
    
    /// The thickness of the ring.
    var ringThickness: Double = 15
    
    /// The background color of the ring.
    var ringBackgroundColor: UIColor = UIColor(white: 0.9, alpha: 1)
    
    /// The divisions radius.
    var divisionsRadius: Double = 1.25
    
    /// The divisions color.
    var divisionsColor: UIColor = UIColor(white: 0.5, alpha: 1)
    
    /// The padding between ring and divisions.
    var divisionsPadding: Double = 12
    
    /// The subdivisions radius.
    var subDivisionsRadius: Double = 0.75
    
    /// The subdivisions color.
    var subDivisionsColor: UIColor = UIColor(white: 0.5, alpha: 0.5)
    ...
    /// Font of value label.
    var valueFont: UIFont = UIFont.systemFont(ofSize: 140)
    
    /// Text color of value label.
    var valueTextColor: UIColor = UIColor(white: 0.1, alpha: 1)
    
    /// A boolean indicates whether to show min/max value.
    var showMinMaxValue: Bool = true
    
    /// Font of min/max value label.
    var minMaxValueFont: UIFont = UIFont.systemFont(ofSize: 12)
    
    /// Text color of min/max value label.
    var minMaxValueTextColor: UIColor = UIColor(white: 0.3, alpha: 1)
    
    /// A boolean indicates whether to show unit of measurement.
    var showUnitOfMeasurement: Bool = true
    
    /// The unit of measurement.
    var unitOfMeasurement: String = "km/h"
    
    /// Font of unit of measurement label.
    var unitOfMeasurementFont: UIFont = UIFont.systemFont(ofSize: 16)
    
    /// Text color of unit of measurement label.
    var unitOfMeasurementTextColor: UIColor = UIColor(white: 0.3, alpha: 1)
